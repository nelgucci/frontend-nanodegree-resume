 ...
 var bio = {
 	...
 	"message": "“Believe in your infinite potential. Your only limitations are those you set upon yourself.” ― Roy T. Bennett",
...
bio.display = function() {
	 ...
	 $('#topContacts').append(formattedGithub.link("https://github.com/nelgucci"));
	 $('#footerContacts').append(formattedGithub.link("https://github.com/nelgucci"));

	 var formattedTwitter = HTMLtwitter.replace('%data%', bio.contacts.twitter);
	 $('#topContacts').append(formattedTwitter.link("https://twitter.com/nelGucci"));
	 $('#footerContacts').append(formattedTwitter.link("https://twitter.com/nelGucci"));

	 var formattedLocation = HTMLlocation.replace('%data%', bio.contacts.location);
     $('#topContacts').append(formattedLocation.link("#"));
     $('#footerContacts').append(formattedLocation.link("#"));
...
education.display = function() {
	...
	for(var ed = 0; ed < education.schools.length; ed++) {
		...
		var formattedOnlineURL = HTMLonlineURL.replace("%data%", education.onlineCourses[ed].url.link("https://www.udacity.com/course/front-end-web-developer-nanodegree--nd001"));
